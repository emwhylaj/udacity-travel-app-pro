...
export const dataFromApi = async function (trip) {
    await Promise.all([
        (async () => {
            ...
            let coordinates = await fetch("http://localhost:9000/getCoordinates", {
                method: 'POST',
            ...
            let weatherData = await fetch("http://localhost:9000/getWeather", {
                method: 'POST',
                credentials: 'same-origin',
                mode: 'cors',
                headers: {
            ...
            let image = await fetch("http://localhost:9000/getImage", {
                method: 'POST',
                credentials: 'same-origin',
                mode: 'cors',
                headers: {
            ...
            try {
                ...
                if (data.use_placeholder) {
                    trip.imageUrl = '../media/hong-kong.jpg'
                } else {
            ...
            let details = await fetch("http://localhost:9000/getCountryDetail", {
                method: 'POST',
                credentials: 'same-origin',
                mode: 'cors',
                headers: {
